...
class blackBox:
	...
	def __init__(self,boxwidth,boxheight,x,y,xmove,ymove):
...
class park:
	...
	def draw(self):
		line1 = pygame.draw.line(screen, self.color,(self.boxXCo,self.boxYCo),(self.boxXCo + self.boxWIDTH,self.boxYCo),thickness)
...
while running:
	...
	box = blackBox(25,25,x,y,xmove,ymove)
	if distance < 5:
		timeInPark += 1
